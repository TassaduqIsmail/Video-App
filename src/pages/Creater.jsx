    ...
    try {
      ...
      const countSub = subData.filter(
        (item) =>
          ...
          item.creatorId === location?.state?.userData?.uid
      );
        ...
        <p className="text-[#a1a3a7] font-thin text-xs ">
          {location?.state?.userData?.username}
              ...
              >
                ...
                >
                  <p style={{ color: "white" }}>{subTotal.length} </p>
              ...
              <div className="subscription-options">
                ...
                <div>
                  {/* <img src={require("../../../asset/Images/Icons/cccc.png")} style={{ height: 20, width: 20 }} alt="Checkmark Icon" /> */}
                  <p style={{ color: "#FFF" }}>See user's posts</p>
                </div>
                <div>
                  {/* <img src={require("../../../asset/Images/Icons/cccc.png")} style={{ height: 20, width: 20 }} alt="Checkmark Icon" /> */}
                  <p style={{ color: "#FFF" }}>See user's content</p>
                </div>
                <div>
                  {/* <img src={require("../../../asset/Images/Icons/cccc.png")} style={{ height: 20, width: 20 }} alt="Checkmark Icon" /> */}
                  <p style={{ color: "#FFF" }}>
              ...
              >
                <button
                  style={{
                    color: subStaus === "subscribe" ? "red" : "green",
                    borderWidth: 2,
                    padding: 10,
                    paddingVertical: 5,
                    alignItems: "center",
                    borderRadius: 30,
                    borderWidth: 3,
                    borderColor: subStaus === "subscribe" ? "red" : "green",
                  }}
                  onClick={() => {
                    {
                      subStaus === "subscribe"
                        ? unsubscribe()
                        : navigate("/checkPayment", { state: { currentdata } });
                    }
                    window.location.reload();
                  }}
                >
          ...
          >
            ...
            >
              ...
              >
                ...
                <span style={{ color: "#FFF", marginLeft: "3px" }}>{currentImages.length ?currentImages.length :0 }</span>
              </div>
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                <span style={{ color: "#FFF", marginLeft: "3px" }}>{currentVideo.length ?currentVideo.length :0 }</span>
              </div>
            </div>
            <div>
              <svg
