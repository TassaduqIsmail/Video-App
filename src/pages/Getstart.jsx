...
{/* <AiOutlineClose className='m-2'  color='white'/> */}
    ...
    <p className='text-white text-2xl mt-20 font-bold'>Set Up Your Profile</p>

    <p className='text-white text-sm mt-10 m-5 '>Personalize your experience by creating a profile. Share your interests, add a photo, and let others get to know the real you.</p>
